    ...
    element.innerHTML = `
      <style>
        .wf-container {
          ...
          color: #000;
          overflow: hidden; /* Evita quebras de scroll no tile */
        ...
        /* Container dedicado às barras para maximizar os 100% do tamanho */
        .wf-bars-container {
          position: absolute;
          top: 60px; /* Espaço cravado para a seta e rótulos de topo */
          bottom: 0;
          left: 0;
          right: 0;
          display: flex;
